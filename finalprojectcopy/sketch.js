...
class Player {
    constructor() {
      ...
      display(){
        if (keyIsDown(LEFT_ARROW)) { //keyIsDown(LEFT_ARROW)
          ...
          else if (keyIsDown(RIGHT_ARROW)) {//keyIsDown(RIGHT_ARROW)
            synth1.triggerAttackRelease('C4', '8n');
          ...
          else if (keyIsDown(UP_ARROW) ) {//keyIsDown(UP_ARROW)
          ...
          else if (keyIsDown(DOWN_ARROW)) {//keyIsDown(DOWN_ARROW)
            synth2.triggerAttackRelease('C4', '8n');
            if (this.lives === 3){
              this.y = this.y + 7;
